...
(function() {
	...
	var Particle = function(parent, x, y) {
		...
		this.radius = getLimitedRandom(0.80, 3.5); //1.5 , 2.5
		this.opacity = 0;
		this.x = x || Math.random() * this.canvas.width;
		this.y = y || Math.random() * this.canvas.height;
		this.velocity = {
			x: ((Math.random()/1.85))/* * parent.options.velocity */,
			y: ((Math.random()/1.85))/* * parent.options.velocity*/
      //Math.random() 
		};
	};
	...
	var ParticleNetwork = function(parent) {
		this.options = {
			...
			density: 10000, // the lower the denser 15000
			netLineDistance: 225,
			netLineColor: '#929292',
